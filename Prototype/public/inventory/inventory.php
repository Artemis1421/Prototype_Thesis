        ...
        <div class="flex flex-col w-full bg-gray-100">
            <div class="flex justify-between p-6 mx-6">
                ...
                <div>
                    ...
                    id="addForm">
                        <form class="flex flex-col p-12 space-y-1" method="post" action="add_products.php">
                            <div class="mb-4">
                                <h3 class="text-xs tracking-wide text-gray-600 uppercase">Product Name</h3>
                                <input class="w-full py-1 rounded-md" type="text" name="add_product_name" required>

                                <h3 class="text-xs tracking-wide text-gray-600 uppercase">Category</h3>
                                <select class="w-full py-1 rounded-md" name="add_product_category" required>
                                ...
                                <input class="w-full py-1 rounded-md" type="number" name="add_product_quantity" min="0" required>

                                <h3 class="text-xs tracking-wide text-gray-600 uppercase">Sale Price</h3>
                                <input class="w-full py-1 rounded-md" type="number" step="any" name="add_product_price" min="0" required>
                            </div>

                            <div class="flex w-full px-4 space-x-2">
                                <input 
                                class="w-1/2 py-1 text-white bg-green-500 rounded-md hover:bg-green-600" 
                    ...
                    id="products_table">
                            ...
                            <tr class= "items-center text-sm text-gray-600 border-b border-gray-400 item">
                                ...
                                <td class="flex items-center justify-center h-6 space-x-2">
                                    ...
                                    href="add_stock.php?id=<?php echo md5($row['id']) ?>"
                                    > 
                                    ...
                                    <a 
                                    class="w-4 transform hover:text-green-500 hover:scale-110"
                                    href="delete_products.php?id=<?php echo $row['id'] ?>" 
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
