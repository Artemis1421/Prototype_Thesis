...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2021 at 10:57 AM
...
--
DELIMITER $$
CREATE TRIGGER `sales_insert_update` AFTER INSERT ON `orders` FOR EACH ROW begin
UPDATE sales
...
--
DELIMITER $$
CREATE TRIGGER `stocks_insert_update` AFTER UPDATE ON `products` FOR EACH ROW begin
